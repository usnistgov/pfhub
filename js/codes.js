...
(function() {
  var add_description, add_header, add_icon, add_icons, add_language, add_logo, add_stats, build_function, data_file, icons, sort_func;
  ...
  add_language = function(selection) {
    var subselection;
    subselection = selection.filter(function(d) {
      return "language" in d;
    });
    return subselection.append("p").text(function(d) {
