...
\begin{itemize}
  \item Upload new data upload specficiations (e.g. the phase-field
    benchmarks in the PFHub website~\cite{pfhub}) in a format that
    Jekyll can parse, \emph{e.g.}, Jupyter Notebook, Markdown or HTML.
